...
toy_part_data:
	python3 generate_training_data.py --output_dir data/toy_part --traffic_df_filename data/toy_part.h5 --edge_weights_filename data/toy/part_graph{}.csv --subdatasets 4 --stride 2
...
fab_embedding_train:
	python3 train.py --data data/fab_full --adjdata data/sensor_graph/full_adj_mx.pkl --do_graph_conv --aptonly --addaptadj --randomadj --num_nodes 20 --cat_feat_gc --downscale_input --upscale_output --save logs/fab_embedding
...
fab_partition_regression:
	python3 regression.py --data data/fab_part --adjdata data/sensor_graph/part_adj_mx.pkl --do_graph_conv --addaptadj --randomadj --num_nodes 20 --cat_feat_gc --checkpoint logs/fab_partition/best_model.pth --label_path data/fab_full
...
toy_embedding_train:
	python3 train.py --device cpu --data data/toy_full --adjdata data/sensor_graph/full_adj_mx.pkl --do_graph_conv --aptonly --addaptadj --randomadj --num_nodes 20 --cat_feat_gc --downscale_input --upscale_output --save logs/toy_embedding
...
toy_partition_regression:
	python3 regression.py --device cpu --data data/toy_part --adjdata data/sensor_graph/part_adj_mx.pkl --do_graph_conv --addaptadj --randomadj --num_nodes 20 --cat_feat_gc --checkpoint logs/toy_partition/best_model.pth --label_path data/toy_full
